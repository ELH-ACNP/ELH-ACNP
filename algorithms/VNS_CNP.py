...
class VNS(object):
    ...
    def initial_neighborhood_manager(self):
        ...
        self.neighborhood_shaking = [(item1, item2) for item1 in destroy_list for item2 in repair_list]
        random.shuffle(self.neighborhood_shaking)
    ...
    def run(self):
        ...
        while True:
            ...
            # 5.1 random select a neighborhood data---Shaking
            self.neighborhood_method = random.choice(self.neighborhood_shaking)
