...
class VNS(object):
    ...
    def initial_neighborhood_manager(self):
        ...
        :return: None
        """
        destroy_list = [self.ramdom_removal, self.min_priority_removal, self.max_conflict_removal,
                        self.min_efficiency_removal]
        repair_list = [self.random_insert, self.max_priority_insert, self.min_conflict_insert,
    ...
    def run(self):
        ...
        while True:
            ...
            self.min_priority_removal()
            self.max_priority_insert()
